...
class BoardCell {
  bool isWall = false;
  int customWallIndex = 0; // 0 = base wall, 1-6 = custom walls
  int customFloorIndex = 0; // 0 = default floor, 1-6 = custom floors
  ...
  BoardCell clone() {
    ...
    cell.isWall = isWall;
    cell.customWallIndex = customWallIndex;
    cell.customFloorIndex = customFloorIndex;

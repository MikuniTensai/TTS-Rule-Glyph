...
String _soloSplitPath(int zeroBasedIndex) {
  if (zeroBasedIndex < 22) {
    return 'assets/levels/solo/chap1/${zeroBasedIndex + 1}.json';
  }
  final afterChapterOne = zeroBasedIndex - 22;
  final chapter = 2 + afterChapterOne ~/ 12;
  final levelInChapter = 1 + afterChapterOne % 12;
  return 'assets/levels/solo/chap$chapter/$levelInChapter.json';
}
